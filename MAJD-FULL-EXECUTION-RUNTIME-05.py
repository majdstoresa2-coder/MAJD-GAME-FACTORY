...
(نسخة لا تعتمد على 01, 02, ولا 03 - ستنجح دائماً)
"""
...
# ============================================================
# 1. بناء اللعبة يدوياً (بدون 03.py)
# ============================================================
...
const world={width:2400,height:1350,goal:{x:2180,y:1080,width:90,height:120},obstacles:[{x:520,y:1020,w:150,h:150},{x:930,y:900,w:170,h:270}]};
